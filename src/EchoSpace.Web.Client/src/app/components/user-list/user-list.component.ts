...
export class UserListComponent implements OnInit {
  ...
  onConfirm(): void {
    ...
    if (action === 'delete') {
      this.userService.deleteUser(userId).subscribe({ next: handleSuccess, error: handleError });
    } else if (action === 'lock') {
      this.userService.lockUser(userId).subscribe({ next: handleSuccess, error: handleError });
    } else if (action === 'unlock') {
      this.userService.unlockUser(userId).subscribe({ next: handleSuccess, error: handleError });
    }
  }
